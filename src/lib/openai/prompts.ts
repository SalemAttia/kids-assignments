...
- التوزيع المقترح للمستوى الصعب (تقريبي، عدّله حسب المحتوى):
  • 35-45% multiple_choice بمشتتات مقنعة جداً
  • 20-25% multi_select (اختر كل اللي ينطبق)
  • 15-20% true_false بفخاخ دقيقة
  • 15-20% short_answer أو fill_blank
- ممنوع تستخدم نفس النوع لأكتر من 40% من الأسئلة`
    : difficulty === 'medium'
    ? `- نوّع في أنواع الأسئلة: استخدم 3 أنواع مختلفة على الأقل
- الأغلبية multiple_choice، مع كام سؤال true_false أو fill_blank، وممكن سؤال multi_select لو المحتوى مناسب`
