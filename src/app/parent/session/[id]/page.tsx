...
export default function ParentSessionDetailPage() {
  ...
  useEffect(() => {
    ...
    if (!sessionId) { router.replace('/parent/dashboard'); return }
  ...
  if (notFound || !session) return (
    <main className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 p-4" dir="rtl">
      <div className="max-w-md mx-auto pt-10 text-center">
        ...
        <button onClick={() => router.push('/parent/dashboard')} className="px-6 py-3 bg-blue-500 text-white rounded-2xl font-bold">رجوع</button>
      </div>
    </main>
  )
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 p-4" dir="rtl">
      <div className="max-w-md mx-auto pt-2 pb-8 space-y-4">
